...
\begin{frame}{Adding the Quiver (cont.)}
    \begin{definition}
        A \textbf{quiver} $Q = (Q_0, Q_1, s, t)$ where $Q_0$ is vertex set, $Q_1$ is the arrow set, $s:Q_1 \to Q_0$ gives the source vertex of an arrow, and $t:Q_1 \to Q_0$ gives the target vertex of an arrow.
    \end{definition}
	\begin{center}
